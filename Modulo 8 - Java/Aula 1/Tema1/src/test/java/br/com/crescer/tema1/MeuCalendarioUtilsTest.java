...
import static br.com.crescer.tema1.CalendarUtils.DiaSemana.DOMINGO;
import static br.com.crescer.tema1.CalendarUtils.DiaSemana.QUARTA_FEIRA;
import static br.com.crescer.tema1.CalendarUtils.DiaSemana.QUINTA_FEIRA;
import static br.com.crescer.tema1.CalendarUtils.DiaSemana.SABADO;
import static br.com.crescer.tema1.CalendarUtils.DiaSemana.SEGUNDA_FEIRA;
import static br.com.crescer.tema1.CalendarUtils.DiaSemana.SEXTA_FEIRA;
import static br.com.crescer.tema1.CalendarUtils.DiaSemana.TERCA_FEIRA;
...
public class MeuCalendarioUtilsTest {
    ...
    private final CalendarUtils calendarUtils = new MeuCalendarioUtils();
    ...
    public void testTempoDecorrido() {
        ...
        final String format = String.format("%s ano(s), %s mese(s) e %s dia(s)", 
                between.getYears(), 
                between.getMonths(), 
                between.getDays());
