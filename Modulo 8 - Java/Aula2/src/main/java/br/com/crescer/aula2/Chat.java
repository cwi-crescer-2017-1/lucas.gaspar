...
import br.com.crescer.tema1.MeuCalendarioUtils;
import br.com.crescer.tema1.StringManipulation;
...
public class Chat {
    ...
    private static final StringUtils STRING_UTILS = new StringManipulation();
    ...
    public static void main(String[] args) {
        if (args.length < 2) {
            args = new String[]{"\\\\10.0.100.102\\cwitmp\\carloshenrique\\aula.txt", "@Gaspar"};
        }
